    ...
    <footer className="flex w-full flex-col border-t mt-6">
      <div className="mx-auto w-full lg:py-6 lg:flex lg:items-center lg:justify-between max-w-6xl gap-2">
            ...
            <div className="flex items-center gap-3 justify-center md:justify-start mb-1">
              <div className="flex items-center">
                <img
                  ...
                  className="-mt-1"
                />
                <span className="text-small font-medium ml-2">MCPSvr</span>
              </div>
        ...
        <div className="text-sm text-gray-400 px-4 lg:px-0 lg:my-0 my-2">
          ...
          platform empowers developers to discover exceptional tools while
          offering a streamlined process for sharing their own MCP server
          creations.
        </div>
      </div>
    </footer>
